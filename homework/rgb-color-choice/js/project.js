// 1. Use document.getElementById() and assign the .onclick event to #color-button
 ...
 var changeColor = document.getElementById('#color-button').onClick = changeColor;
...
var red = document.getElementById('#red').value = red;
var green = document.getElementById('#green').value = green;
var blue = document.getElementById('#blue').value = blue;
}
...
document.getElementByIdName('#wrapper').style.background.color = colorStr;